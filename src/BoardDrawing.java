...
public class BoardDrawing extends JPanel {
    ...
    /**
     *
     * @param row aqui se la pasara la linea en la cual se dibujara
     * @param col aqui se la pasara la columna en la cuel se dibujara
     * @param bs aqui esta la zona donde se podra clickar 
     */
    ...
    /**
     *
     * @param g aqui se le pasara los graficos.
     */
    ...
    /**
     * lo que hace esta funcion es decir la posicion donde esta el jugador
     */
    ...
    /**
     *
     * @param pnos  aqui se le pasarala posicion de la partida por la que va.
     * @return
     */
    ...
    /**
     *
     * @param a aqui le pasaremos el numero del jugador
     */
    ...
    /**
     *
     * @param a aqui se le añadira la posicion del jugador
     * @param pnos aqui se le añadiremos la posicion dentro del indice de los jugador que vamos a buscar
     */
